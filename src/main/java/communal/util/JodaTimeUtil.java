...
public class JodaTimeUtil {
    ...
    private static final String PATTERN_STANDARD_OTHER = "yyyyMMddHHmmssS";
    ...
    public static String getCurrentDateTimeOther() {
        DateTime dt = new DateTime();
        String time = dt.toString(PATTERN_STANDARD_OTHER);
        return time;
    }
    /**
     * 获取当前日期
    ...
    public static void main(String[] args) {
        ...
        System.out.println(str2Date("2021-04-11 14:10:01"));
        System.out.println(isTimeExpired(new Date()));
        System.out.println(isTimeExpired("2021-05-11 14:11:20"));
        System.out.println(isBeforeNow("2221-05-11 14:11:20"));
        System.out.println(plusDays(new Date(), 5));
        System.out.println(minusDays(new Date(), 5));
        System.out.println(plusMinutes(new Date(), 10));
        System.out.println(minusMinutes(new Date(), 10));
        System.out.println(plusMonths(new Date(), 3));
        System.out.println(minusMonths(new Date(), 3));
        System.out.println(isBetween(new Date(), minusDays(new Date(), 5), plusDays(new Date(), 5)));

        System.out.println(getCurrentDateTime());
        System.out.println(getCurrentDate());
        System.out.println(getCurrentTime());

        System.out.println(getAssignedDateTime(2020, 3, 5, 12, 22, 13));
        System.out.println(getAssignedDate(222, 3, 4));
        System.out.println(getAssignedTime(12, 12, 12));
        System.out.println(getWeek());
        System.out.println(getWeek(2020, 2, 2));
        System.out.println(diffDay(new Date(), plusDays(new Date(),5)));

        System.out.println(getCurrentDateTimeOther());
    }
}
